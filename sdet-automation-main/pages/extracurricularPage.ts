...
export class ExtracurricularPage {
    ...
    async submitExtracurricularForm() {
    ...
    async fillExtracurricularForm(activity: string, years: string, leadership: string, description: string, index: number, indexT: number) {
